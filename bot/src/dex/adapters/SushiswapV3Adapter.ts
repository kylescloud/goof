/**
 * @file SushiswapV3Adapter.ts
 * @description Adapter for SushiSwap V3 on Base. Uses SushiSwap's V3 quoter and router.
 *              Handles the same exactInputSingle and exactInput patterns as UniswapV3Adapter.
 */
...
export class SushiswapV3Adapter extends BaseDexAdapter {
  readonly dexId = DexId.SUSHISWAP_V3;
  readonly name = 'SushiSwap V3';
  ...
  constructor(provider: ethers.Provider, factoryAddress: string, routerAddress: string, quoterAddress: string) {
    super(provider, factoryAddress, routerAddress, 'SushiswapV3Adapter');
