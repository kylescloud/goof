...
function parseConfig(): Config {
  const raw = {
    ...
    discoveryBatchSize: parseInt(process.env.DISCOVERY_BATCH_SIZE || '200', 10),
    ...
    minPoolLiquidityUsd: parseFloat(process.env.MIN_POOL_LIQUIDITY_USD || '10000'),
    ...
    v2v3DivergenceThresholdBps: parseInt(process.env.V2V3_DIVERGENCE_THRESHOLD_BPS || '30', 10),
    wethCircuitBreakerPct: parseFloat(process.env.WETH_CIRCUIT_BREAKER_PCT || '2'),
    stableDepegThresholdBps: parseInt(process.env.STABLE_DEPEG_THRESHOLD_BPS || '10', 10),
  };
